...
`shared-tasks.validation-cases.json` adds advanced model-validation checks for actor-capability authorization, actor-binding correctness, and persistence durability contracts.
